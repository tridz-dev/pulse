              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-slab-2/50 border border-rule-2 p-4 rounded-xl flex flex-col gap-1">
                  <div className="flex justify-between items-center">
                    ...
                    <Badge variant="outline" className="text-[9px] uppercase tracking-wider h-4 border-rule-2 text-mute">
                  ...
                  <span className={cn(
                    ...
                    personalScore?.score !== null && personalScore?.score !== undefined
                      ? (personalScore.score >= 0.8 ? 'text-pass' : personalScore.score >= 0.5 ? 'text-risk' : 'text-fail')
                      : 'text-faint'
                  )}>
                    {personalScore?.score !== null && personalScore?.score !== undefined
                ...
                <div className="bg-slab-2/50 border border-rule-2 p-4 rounded-xl flex flex-col gap-1">
                  ...
                  <span className={cn(
                    ...
                    inheritedScore?.score !== null && inheritedScore?.score !== undefined
                      ? (inheritedScore.score >= 0.8 ? 'text-pass' : inheritedScore.score >= 0.5 ? 'text-risk' : 'text-fail')
                      : 'text-faint'
                  )}>
                    {inheritedScore?.score !== null && inheritedScore?.score !== undefined
